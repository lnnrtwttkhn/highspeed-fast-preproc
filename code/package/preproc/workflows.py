...
def workflow_l1analysis(cfg, events_id, leave_out):
    ...
    wf.connect(num_voxels_tmap_mask, 'out_path', datasink, '{}.num_voxels_tmap_mask.@out_path'.format(wf.name))
    ...
    wf.connect(num_voxels_tmap_mask_thresh_bin, 'out_path', datasink, '{}.num_voxels_tmap_mask_thresh_bin.@out_path'.format(wf.name))
