...
def get_paths(cfg):
    ...
    file_func = os.path.join('ses-*', 'func', '*space-T1w*preproc_bold.nii.gz')
    ...
    file_events = os.path.join('ses-*', 'func', '*events.tsv')
    file_confounds = os.path.join('ses-*', 'func', '*confounds_timeseries.tsv')
