...
wf.connect(mask_parc, 'output_file', mask_vis, 'in_file')
wf.connect(mask_parc, 'output_file', mask_hpc, 'in_file')
wf.connect(mask_parc, 'output_file', mask_mot, 'in_file')
wf.connect(mask_parc, 'output_file', mask_mtl, 'in_file')
